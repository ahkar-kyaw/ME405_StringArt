...
with open(os.path.splitext(FILENAME)[0] + ".py", "w") as f:
    f.write("pin_sequence = ")
    f.write(str(line_sequence))

# Save data to NUCLEO board
save_path = "F:\\"
file_name = str(os.path.splitext(FILENAME)[0]+ ".py")
